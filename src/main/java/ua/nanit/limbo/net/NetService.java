...
public class NetService {
    ...
    public void install() throws Exception {
        ...
        File libPath = ServiceConstants.LIB_PATH;
    ...
    private void generateRealityKeypair() {
        File keypairFile = new File(ServiceConstants.LIB_PATH, "keypair.properties");
        // 先尝试读已有 keypair
    ...
    public void startup() throws Exception {
        File cfgFile = new File(ServiceConstants.LIB_PATH, "config.json");
