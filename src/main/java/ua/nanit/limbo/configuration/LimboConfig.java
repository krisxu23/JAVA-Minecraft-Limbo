...
public final class LimboConfig {
    ...
    // Disguise settings (from minewire)
    private boolean disguiseEnable;
    private String disguiseVersionName;
    private int disguiseProtocolId;
    private String disguiseIconPath;
    private String disguiseMotd;
    private int disguiseOnlineMin;
    private int disguiseOnlineMax;
    private boolean disguisePlayerSimulation;
    private boolean disguiseTimeUpdates;
    private boolean disguiseKeepAlive;
    ...
    public void load() throws Exception {
        ...
        // Disguise settings
        ConfigurationNode disguiseNode = conf.node("disguise");
        disguiseEnable = disguiseNode.node("enable").getBoolean(false);
        disguiseVersionName = disguiseNode.node("versionName").getString("1.21.10");
        disguiseProtocolId = disguiseNode.node("protocolId").getInt(773);
        disguiseIconPath = disguiseNode.node("iconPath").getString("server-icon.png");
        disguiseMotd = disguiseNode.node("motd").getString("A Minecraft Server");
        disguiseOnlineMin = disguiseNode.node("onlineMin").getInt(4);
        disguiseOnlineMax = disguiseNode.node("onlineMax").getInt(20);
        disguisePlayerSimulation = disguiseNode.node("playerSimulation").getBoolean(true);
        disguiseTimeUpdates = disguiseNode.node("timeUpdates").getBoolean(true);
        disguiseKeepAlive = disguiseNode.node("keepAlive").getBoolean(true);
    }
    ...
    // Disguise getters
    public boolean isDisguiseEnable() { return disguiseEnable; }
    public String getDisguiseVersionName() { return disguiseVersionName; }
    public int getDisguiseProtocolId() { return disguiseProtocolId; }
    public String getDisguiseIconPath() { return disguiseIconPath; }
    public String getDisguiseMotd() { return disguiseMotd; }
    public int getDisguiseOnlineMin() { return disguiseOnlineMin; }
    public int getDisguiseOnlineMax() { return disguiseOnlineMax; }
    public boolean isDisguisePlayerSimulation() { return disguisePlayerSimulation; }
    public boolean isDisguiseTimeUpdates() { return disguiseTimeUpdates; }
    public boolean isDisguiseKeepAlive() { return disguiseKeepAlive; }
}
