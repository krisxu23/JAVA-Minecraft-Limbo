...
public final class LimboConfig {
    ...
    public LimboConfig(Path root) { this.root = root; }
    ...
    public void load() throws Exception {
        ...
        if (dimensionType.equalsIgnoreCase("nether")) dimensionType = "the_nether";
        if (dimensionType.equalsIgnoreCase("end")) dimensionType = "the_end";
        gameMode = conf.node("gameMode").getInt(3);
        useBrandName = conf.node("brandName", "enable").getBoolean(true);
        useJoinMessage = conf.node("joinMessage", "enable").getBoolean(true);
        useBossBar = conf.node("bossBar", "enable").getBoolean(true);
        useTitle = conf.node("title", "enable").getBoolean(true);
        usePlayerList = conf.node("playerList", "enable").getBoolean(false);
        playerListUsername = conf.node("playerList", "username").getString("Steve");
        useHeaderAndFooter = conf.node("headerAndFooter", "enable").getBoolean(false);

        if (useBrandName) brandName = conf.node("brandName", "content").getString("vanilla");
        ...
        readTimeout = conf.node("readTimeout").getLong(30000L);
    ...
    private BufferedReader getReader() throws IOException {
        ...
        if (!Files.exists(filePath)) {
            ...
            if (stream == null) throw new FileNotFoundException("Cannot find settings.yml");
    ...
    public PingData getPingData() { return pingData; }
    public String getDimensionType() { return dimensionType; }
    public int getGameMode() { return gameMode; }
    public InfoForwarding getInfoForwarding() { return infoForwarding; }
    public long getReadTimeout() { return readTimeout; }
    public int getDebugLevel() { return debugLevel; }
    public boolean isUseBrandName() { return useBrandName; }
    public boolean isUseJoinMessage() { return useJoinMessage; }
    public boolean isUseBossBar() { return useBossBar; }
    public boolean isUseTitle() { return useTitle; }
    public boolean isUsePlayerList() { return usePlayerList; }
    public boolean isUseHeaderAndFooter() { return useHeaderAndFooter; }
    public String getBrandName() { return brandName; }
    public String getJoinMessage() { return joinMessage; }
    public BossBar getBossBar() { return bossBar; }
    public Title getTitle() { return title; }
    public String getPlayerListUsername() { return playerListUsername; }
    public String getPlayerListHeader() { return playerListHeader; }
    public String getPlayerListFooter() { return playerListFooter; }
    ...
    public boolean isUseTrafficLimits() { return useTrafficLimits; }
    public int getMaxPacketSize() { return maxPacketSize; }
    public double getInterval() { return interval; }
    public double getMaxPacketRate() { return maxPacketRate; }
}
